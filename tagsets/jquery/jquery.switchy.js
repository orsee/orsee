!function ($) {
  ...
  * ====================== */
  ...
  var Switchy = function (element, options) {
    ...
    this.firstOptionLabel = this.$options.first().text();
    this.lastOptionLabel = this.$options.last().text();
    this.firstOptionLabelHTML = $.parseHTML('<div class="switchy-labels">' + this.firstOptionLabel + '</div>');
    this.lastOptionLabelHTML = $.parseHTML('<div class="switchy-labels">' + this.lastOptionLabel + '</div>');
    this.init();
  }
  ...
  Switchy.prototype = {
    ...
    init: function(){
      ...
      this.$element.after(this.lastOptionLabelHTML);
      this.$element.after(this.$container);
      this.$element.after(this.firstOptionLabelHTML);
