...
function stats__textstats_all() {
	...
	$output.=stats__get_textstats('degree');
	$output.=stats__get_textstats('begin_of_studies');
	$output.=stats__get_textstats('profession');
	$output.=stats__get_textstats('country');
	$output.=stats__get_textstats('firstlanguage');
	...
	$output.=stats__get_textstats('activity_by_month');
	return $output;
}
...
function stats__participant_htmlstats_all() {
	...
	$output.=stats__get_htmlstats('degree');
	$output.=stats__get_htmlstats('begin_of_studies');
        $output.=stats__get_htmlstats('profession');
	$output.=stats__get_htmlstats('country');
	$output.=stats__get_htmlstats('firstlanguage');
	...
	$output.=stats__get_htmlstats('activity_by_month');
	$output.='</TABLE>';
...
function stats__participant_graphstats_all() {
	...
	$output.=stats__get_graphstats('degree');
	$output.=stats__get_graphstats('begin_of_studies');
        $output.=stats__get_graphstats('profession');
	$output.=stats__get_graphstats('country');
	$output.=stats__get_graphstats('firstlanguage');
	...
	$output.=stats__get_graphstats('activity_by_month');
        $output.='</TABLE>';
...
function stats__array_degree() {
        global $lang, $subpool_id;
        $stat=array();
        // titles ect ...
        $stat['xtitle']='';
        $stat['ytitle']='';
        $stat['title']=$lang['degrees'];
        $stat['graphtype']='pie';
        $stat['legend']=array();
        $stat['legend_y']='';
        $stat['legend_y']='';
        ...
        $query="SELECT degree, count(participant_id) as nrpart,
                ".$lang['lang']." as deg
                FROM ".table('participants').", ".table('lang')."
                WHERE deleted='n'
                AND degree!='0'
                AND degree=content_name
                AND content_type='degree' ".
                $qsubpool."
                GROUP BY degree
                ORDER BY nrpart DESC, deg";
        $result=mysql_query($query) or die("Database error: " . mysql_error());
        while ($line=mysql_fetch_assoc($result)) {
                $stat['legend'][]=stripslashes($line['deg']);
                $data[0][]=$line['nrpart'];
                }
        $stat['data']=$data;
        return $stat;
...
function stats__array_country() {
        global $lang, $subpool_id;
        $stat=array();
        // titles ect ...
        $stat['xtitle']='';
        $stat['ytitle']='';
        $stat['title']=$lang['country'];
        $stat['graphtype']='pie';
        $stat['legend']=array();
        $stat['legend_y']='';
        $stat['legend_y']='';
        ...
        $query="SELECT country, count(participant_id) as nrpart,
                ...
                $qsubpool."
                GROUP BY country
                ORDER BY nrpart DESC, countryname";
        $result=mysql_query($query) or die("Database error: " . mysql_error());
        while ($line=mysql_fetch_assoc($result)) {
                $stat['legend'][]=stripslashes($line['countryname']);
                $data[0][]=$line['nrpart'];
                }
        $stat['data']=$data;
        return $stat;
...
function stats__array_firstlanguage() {
        global $lang, $subpool_id;
        $stat=array();
        // titles ect ...
        $stat['xtitle']='';
        $stat['ytitle']='';
        $stat['title']=$lang['first_language'];
        $stat['graphtype']='pie';
        $stat['legend']=array();
        $stat['legend_y']='';
        $stat['legend_y']='';
        ...
        $query="SELECT firstlanguage, count(participant_id) as nrpart,
                ".$lang['lang']." as flang
                FROM ".table('participants').", ".table('lang')."
                WHERE deleted='n'
                AND firstlanguage!='0'
                ...
                $qsubpool."
                GROUP BY firstlanguage
                ORDER BY nrpart DESC, flang";
        $result=mysql_query($query) or die("Database error: " . mysql_error());
        while ($line=mysql_fetch_assoc($result)) {
                $stat['legend'][]=stripslashes($line['flang']);
                $data[0][]=$line['nrpart'];
                }
        $stat['data']=$data;
        return $stat;
...
function stats__array_activity_by_month() {
        global $lang, $subpool_id;
        ...
        // titles ect ...
        $stat['xtitle']=$lang['month'];
        $stat['ytitle']=$lang['cum_count'];
        $stat['title']=$lang['last_activity_by_month'];
        $stat['graphtype']='bars';
        $stat['xsize']=600;
	$stat['x_label_angle']=90;
